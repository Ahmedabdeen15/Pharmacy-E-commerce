...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     return Scaffold(
      appBar: const CustomAppBarr(title: " Profile ",iconDiplay: true,),
        body: Column(
          children: [
            Container(
              height: 200,
             ...
             // decoration: BoxDecoration(gradient: AppColors.primaryColor),
              child: const Row(
                ...
                children: [
                  CircleAvatar(
                  radius: 70,
                  child: Icon(Icons.person, size: 140,color:Color.fromARGB(255, 0, 186, 211),),
                ),
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    const Spacer(),
                        ...
                        IconButton(onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => const AlarmLogout() ));
                        },
                        icon: const Icon(Icons.arrow_forward_ios),
                        color: AppColors.black,
                      ),
